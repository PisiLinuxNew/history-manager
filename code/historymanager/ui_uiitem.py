...
class Ui_HistoryItemWidget(object):
    def setupUi(self, HistoryItemWidget):
        ...
        self.iconLabel.setPixmap(QtGui.QPixmap("../../service-manager/manager/ui/icons/stopped.png"))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/dotakeback.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/details.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.planPB.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/plan.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
